...
<div class="container-fluid">
    <div>
        <img src={{ asset("images/encabezado.png") }} style="height:200px;width:100%" alt="Prubea" title="Prueba"> 
    </div>
    ...
    <div class="row">
       <div class="col-md-4">
        <nav id="sidebar">
            ...
            <div class="img bg-wrap text-center py-4" style="background-image: url(https://colorlib.com/etc/bootstrap-sidebar/sidebar-09/images/bg_1.jpg);">
            <div class="user-logo">
            <div class="img" style="background-image: url(https://colorlib.com/etc/bootstrap-sidebar/sidebar-09/images/logo.jpg);"></div>
            ...
            <li>
            <a href="{{ route('cursos.index') }}"><span class="fa fa-download mr-3 notif"><small class="d-flex align-items-center justify-content-center">5</small></span> Cursos</a>
            </li>
            <li>
            <a href="{{ route('productos.index') }}"><span class="fa fa-gift mr-3"></span>Productos</a>
            </li>
            <li>
            <a href="#"><span class="fa fa-trophy mr-3"></span>Blog</a>
            </li>
            <li>
       ...
       <div class="col-md-8">
        ...
        <footer style="background:gray;width:100%">
            <h3 style="color:white">Practica del curso de Laravel</h3>
        </footer>        
